...
import { speakPilot, playNotificationChime } from "../../utils/helpers";

const FlyingMode = ({ origin, destination, duration, missionGoal, squadCode, currentPlaneId, playEndSound, onFinish, segmentInfo }) => {
